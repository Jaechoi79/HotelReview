  ...
  useEffect(() => {
    ...
    if (hotel) {
      setFormData({
        ...
        review: hotel.review,
        staffComplaint: hotel.scores.staffComplaint,
        staffSpeed: hotel.scores.staffSpeed,
        managerComplaint: hotel.scores.managerComplaint,
        managerSpeed: hotel.scores.managerSpeed,
        facility: hotel.scores.facility,
        cleanliness: hotel.scores.cleanliness,
        experience: hotel.scores.experience,
      })
    } else {
      router.push("/")
    }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        <Button variant="ghost" onClick={() => router.push(`/hotel/${hotelId}`)} className="mb-0">
      ...
      <Card>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="flex justify-between">
            <Button variant="outline" type="button" onClick={() => router.push(`/hotel/${hotelId}`)}>
              {t.cancel}
            </Button>
